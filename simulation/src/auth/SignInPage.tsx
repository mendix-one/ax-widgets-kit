...
const SignInPage = observer(function SignInPage() {
    ...
    <Box>
      ...
      <Box component="form" onSubmit={handleSubmit} noValidate>
        ...
        <Box sx={{ textAlign: 'right', mb: 2 }}>
          <Link component={RouterLink} to="/auth/reset-pass" variant="body2" underline="hover">
...
// Inline SVG data URIs for SSO brand icons (avoids external dependencies)
const googleSvg =
